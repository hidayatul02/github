...
<html lang="en">
    <head>
        ...
        <title>Edit Login | Dayat Variasi</title>
    ...
    <body>
        <div class="container">
			...
			<section class="main">
				<form class="form-2" method="POST" action="../Controller/proses.php?aksi=update_user">
                <?php 
                    $nomor = $_GET['nomor'];
                    $db = new data();
					...
					<p class="float">
                        ...
                        <input type="hidden" name="nomor" value="<?php echo $a['nomor'] ?>">
