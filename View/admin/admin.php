        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="adjust-nav">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Variasi</a>
                </div>
            </div>
        </div>
        <!-- /. NAV TOP  -->
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="../editorder.php?nomor=<?php echo $b ['nomor'] ?>" class="btn btn-primary btn-lg btn-block ">Edit</a>
                                    <a href="../../Controller/proses.php?aksi=delete_order&nomor=<?php echo $b['nomor'] ?>" class="btn btn-success btn-lg btn-block mt-2r">Hapus/<br>Selesai</a>
                                    </td>
                                </tr>
                                <?php } ?>
                                </tbody>
